...
set CLASSPATH=%APP_HOME%\lib\jaylib-test-project-1.0-SNAPSHOT-all.jar

@rem Execute jaylib-test-project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAYLIB_TEST_PROJECT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
